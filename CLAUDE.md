...
**Configuration:** All tunables live in `CONFIG` in `pi_bot/config.py` (model, thresholds, audio devices, TTS parameters). The system prompt is `SYSTEM_PROMPT_DE` in the same file.
